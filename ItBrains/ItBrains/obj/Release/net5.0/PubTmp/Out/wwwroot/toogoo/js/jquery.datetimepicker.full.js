 ...
 */ var DateFormatter;
let today1 = new Date();
let todayhour = today1.getUTCHours()
...
if (todayhour > 22) {
    //today1.setHours(today1.getHours() + 11);
    blockhour = 9;
}

if (todayhour == 24) {
    //today1.setHours(today1.getHours() + 10);
    blockhour = 8;

}
if (todayhour == 1) {
    //today1.setHours(today1.getHours() + 9);
    blockhour = 7;
...
if (todayhour == 3) {
    //today1.setHours(today1.getHours() + 7);
    blockhour = 5;

}
if (todayhour == 4) {
    //today1.setHours(today1.getHours() + 6);
    blockhour = 4;

}
if (todayhour == 5) {
    //today1.setHours(today1.getHours() + 5);
    blockhour = 3;
                ...
                for (a = e.replace(d.separators, "\x00").split("\x00"), u = 0; u < a.length; u++)
                    switch (((i = a[u]), (s = parseInt(i)), n[u])) {
                        ...
                        case "h":
                            if (
                                ((c =
                                    n.indexOf("a") > -1 ? n.indexOf("a") : n.indexOf("A") > -1 ? n.indexOf("A") : -1),
                                    (h = a[c]),
                                    c > -1)
                            )
...
var datetimepickerFactory = function ($) {
    ...
    var default_options = {
        ...
        startDate: today1, // new Date(), '1986/12/08', '-1970/01/05','-1970/01/05',
        step: 60,
        monthChangeSpinner: true,
        blockedHours: blockhour,
        lockTime: 13,
        ...
        onClose: function () { },
        onSave: function (e) {
            var firstresult = new Date(e)

            let hour = firstresult.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: false });
            let month
            if ($(".my-lang").text() == "az") {
                month = firstresult.toLocaleString('en-US', { month: 'short' });
            }
            else if ($(".my-lang").text() == "ru") {
                month = firstresult.toLocaleString('ru-RU', { month: 'short' });
            }
            else if ($(".my-lang").text() == "en") {
                month = firstresult.toLocaleString('en-US', { month: 'short' });

            }

            let day = firstresult.toLocaleString('en-US', { day: 'numeric' });
            firstresult.setHours(firstresult.getHours() + 4);
            let result = firstresult.toISOString().slice(0, -1)
            $("#salam").val(result)
            $("#salam").attr("value", result);
                ...
                timeboxparent
                    .on("scroll_element.xdsoft_scroller", function (event, percentage) {
                        ...
                        timeboxTop = parseFloat(
                            Math.abs((timebox[0].offsetHeight - parentHeight) * percentage).toFixed(4)
                        );
    ...
    $.fn.datetimepicker = function (opt, opt2) {
        ...
        options.minDateTime = new Date().setHours(new Date().getHours() + options.blockedHours);
        ...
        createDateTimePicker = function (input) {
                ...
                _this.str = function () {
                    ...
                    if (options.yearOffset) {
                        ...
                        format = format.replace(
                            "y",
                            String(_this.currentTime.getFullYear() + options.yearOffset).substring(2, 4)
                        );
                    }
            ...
            applyButton.on("touchend click", function (e) {
                ...
                if (isSufficientTime()) {
                    ...
                    input.val(_xdsoft_datetime.str());
                    options.onSave(getCurrentValue());
                    datetimepicker.trigger("close.xdsoft");
                }
            });
            function isSufficientTime() {
                let tomorrow = new Date(new Date().setDate(new Date().getDate() + 1));
                let isTrue = true;
                let h = "";
                let m = "";
                let now = new Date(getCurrentValue());
                ...
                if (options.maxDateTime !== false) {
                    var t = _xdsoft_datetime.strtotime(options.maxDateTime);
                ...
                if (now > new Date()) {
                    if (
                        ...
                        new Date(tomorrow).setHours(0, 0, 0, 0) > new Date(getCurrentValue())
                    ) {
                        isTrue = false;
                    } else {
                        if (
                            tomorrow > getCurrentValue() &&
                            new Date() >= new Date().setHours(options.lockTime, 0, 0, 0)
                        ) {
                            options.disabledHours.forEach((e) => {
                                if (checkNum(e) == getCurrentValue().getHours()) {
                                    isTrue = false;
                                }
                            });
                        } else {
                ...
                .on("xchange.xdsoft", function (event) {
                    ...
                    xchangeTimer = setTimeout(function () {
                        ...
                        var table = "",
                            ...
                            time = "",
                            h,
                            pDay = _xdsoft_datetime.currentTime,
                            line_time,
                            description;
                        ...
                        while (
                            ...
                            if (options.allowDates && options.allowDates.length > 0) {
                                if (
                                    options.allowDates.indexOf(dateHelper.formatDate(start, options.formatDate)) ===
                                    -1
                                ) {
                                    classes.push("xdsoft_disabled");
                                }
                            ...
                            var minDateProto = new Date(
                                new Date().setMinutes(
                                    Math[options.roundTime](new Date().getMinutes() / options.step) * options.step
                                )
                            );
                            var currentDateProto = new Date(new Date(start).setHours(23, 59, 0, 0));
                            if (
                                (maxDate !== false && start > maxDate) ||
                                (minDateTime !== false && minDateProto > currentDateProto) ||
                            ...
                            if (
                                options.disabledDates.indexOf(dateHelper.formatDate(start, options.formatDate)) !==
                                -1
                            ) {
                                classes.push("xdsoft_disabled");
                            }
                            ...
                            if (
                                options.highlightedDates[dateHelper.formatDate(start, options.formatDate)] !==
                                undefined
                            ) {
                                hDate = options.highlightedDates[dateHelper.formatDate(start, options.formatDate)];
                                classes.push(
                                    hDate.style === undefined ? "xdsoft_highlighted_default" : hDate.style
                                );
                        ...
                        line_time = function line_time(h, m, d) {
                            ...
                            if (
                                ...
                                classes.push("xdsoft_time_disabled");
                                classes.push("xdsoft_disabled");
                            }
                            ...
                            let presentTime = new Date(getCurrentValue());
                            if (
                                input.is("[disabled]") ||
                                presentTime.setHours(h) < new Date() ||
                                currentMinutesOfDay >= maxTimeMinutesOfDay ||
                                currentMinutesOfDay < minTimeMinutesOfDay ||
                                isHourSufficient(d)
                            ) {
                        ...
                        function isHourSufficient(d) {
                            let isTrue = false;
                            let tomorrow = new Date(new Date().setDate(new Date().getDate() + 1));
                            if (
                                tomorrow.setHours(0, 0, 0, 0) >= new Date(getCurrentValue()).setHours(0, 0, 0, 0) &&
                                new Date() >= new Date().setHours(options.lockTime, 0, 0, 0)
                            ) {
                                options.disabledHours.forEach((e) => {
                                    if (checkNum(e) == h) {
            ...
            setPos = function () {
                ...
                if (options.fixed) {
                    ...
                    forEachAncestorOf(dateInputElem, function (ancestorNode) {
                        ...
                        if (
                            options.contentWindow.getComputedStyle(ancestorNode).getPropertyValue("position") ===
                            "fixed"
                        ) {
                    ...
                    input.on("keydown.xdsoft", function (event) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                [ESC, ARROWUP, ARROWDOWN, ARROWLEFT, ARROWRIGHT, F5, CTRLKEY, TAB, ENTER].indexOf(
                                    key
                                ) !== -1
                            ) {
                                return true;
