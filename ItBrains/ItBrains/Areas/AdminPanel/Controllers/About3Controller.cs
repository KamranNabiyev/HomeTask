...
namespace ItBrains.Areas.AdminPanel.Controllers
{
    ...
    public class About3Controller : Controller
    {
        ...
        public About3Controller(AppDbContext db, IWebHostEnvironment env)
        {
            _db = db;
            _env = env;
        }
        ...
        {
            About3 about = _db.Abouts3.Where(x => !x.IsDeactive).FirstOrDefault();
            return View(about);
        }
        ...
        public async Task<IActionResult> Update(int? id)
        {
            ...
            About3 dbAbout = await _db.Abouts3.Where(x => x.IsDeactive == false).FirstOrDefaultAsync(y => y.Id == id);
        ...
        public async Task<IActionResult> Update(int? id, About3 about, string imgCropped)
        {
            ...
            var dbAbout = await _db.Abouts3.Where(x => x.IsDeactive == false).FirstOrDefaultAsync(y => y.Id == id);
        ...
        public IActionResult Detail(int? id)
        {
            ...
            About3 about = _db.Abouts3.Where(x => x.IsDeactive == false).FirstOrDefault(y => y.Id == id);
